...
#ifndef VERSION_chat_server
#define VERSION_chat_server "0.1.0.0"
#endif /* VERSION_chat_server */
#ifndef MIN_VERSION_chat_server
#define MIN_VERSION_chat_server(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_chat_server */
...
#define CURRENT_COMPONENT_ID "chat-server-0.1.0.0-inplace-chat-server-exe"
